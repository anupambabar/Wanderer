 ...
 * @author anupam.babar
 */
public class UserAuthenticationSerializer extends JsonDeserializer<UserSecurityBean> {
	 ...
	 */
	@Override
	public UserSecurityBean deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
