...
@NamedQueries({ @NamedQuery(name = "getAllTrnLogDetails", query = "SELECT u FROM TransactionLogEntity u"),
		@NamedQuery(name = "getTrnByRrn", query = "SELECT u FROM TransactionLogEntity u where u.rrn= :rrn"),
		@NamedQuery(name = "getTrnByUserId", query = "SELECT u FROM TransactionLogEntity u where u.userId= :userId") })
@Entity
